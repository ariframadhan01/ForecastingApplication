              ...
              <div class="top-left">
                  <div class="navbar-header">
                     <a class="navbar-brand" alt="Logo">Administrator</a>
                      <a class="navbar-brand hidden" href="./"><img src="images/rama.jpg" alt="Logo"></a>
                              ...
                              <div class="card">
                                  <div class="card-body">
                                      ...
                                      <div id="hai">
                                          <div class="card-body">
                                              <div>
                                                  <img src="images/umk.png" width="80px" height="80px" />
                                                  <a href="https://umk.ac.id/">
                                                  <img src="images/umk.png" width="80px" height="80px" align="right"/>
                                                </a>
                                                              <h4 class="text-sm-center">APLIKASI FORECASTING PENERIMAAN MAHASISWA BARU</h4>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="mx-auto d-block">
                                                                <img class="rounded-circle rounded-circle mr-3" src="images/rama.jpg" alt="Card image cap">
                                                                <h4 class="text-sm-center mt-2 mb-1">Muhammad Arif Ramadhani</h4>
                                                                <h5 class="text-sm-center">201551225</h5>
                                                                <div class="location text-sm-center">Teknik Informatika</div>
                                                                <p></p>
                                                                <a href="https://ariframadhan01.github.io/">
                                                                <h5 class="text-sm-center mt-2 mb-1"></h5>
                                                              </a>
                                                                <div class="location text-sm-center"><i class="fa fa-map-marker"></i> Mijen, RT02/RW03, Kaliwungu, Kudus</div>
                                                            </div>
                                                            <hr>
                                                            <div class="card-text text-sm-center">
                                                                <a href="https://www.facebook.com/arif.ramadhan0"><i class="fa fa-facebook pr-1"></i></a>
                                                                <a href="https://ariframadhan01.github.io/"><i class="fa fa-globe pr-1"></i></a>
                                                                <a href="https://www.instagram.com/arf_ramadhan/"><i class="fa fa-instagram pr-1"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
